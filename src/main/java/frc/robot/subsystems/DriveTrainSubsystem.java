...
public class DriveTrainSubsystem extends SubsystemBase {
  ...
  // Declaring the four drive motos
  ...
  public DriveTrainSubsystem() {
    ...
    frontRight = new CANSparkMax(Constants.DriveConstants.BACK_LEFT_ID, MotorType.kBrushless);
    frontRight = new CANSparkMax(Constants.DriveConstants.BACK_RIGHT_ID, MotorType.kBrushless);
