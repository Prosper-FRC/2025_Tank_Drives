...
public class DriveTrainSubsystem extends SubsystemBase {
  ...
  // Declaring the four drive motors and differential drive
  ...
  public DriveTrainSubsystem() {
    // Instantiate the four drive motors and the differential drive
    ...
    // Make the motors follow each other and set the motors to be inverted
